...
class Main {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Jaivin", 18, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Abhi", 18, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Ankit", 19, 'M');
